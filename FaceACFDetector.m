classdef FaceACFDetector < vision.labeler.AutomationAlgorithm
    properties(Constant)
        ...
        Description = 'Use this algorithm to automatically label RedBook and Face for a Test Dataset';
   ...
   %---------------------------------------------------------------------- 
    ...
    methods
        function initialize(algObj,~)
            ...
            data = load('detectorFaceYolo.mat');
            disp('Model Loaded succesfully');
            algObj.greenBuoyDetector = data.detectorFaceYolo;
        end
